...
from content.site import (BASE_URL, BRAND, NAV, PHONE, PHONE_DISPLAY,
                          TELEGRAM_SITE, TELEGRAM_BIZ, INDEXNOW_KEY)
...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 고양 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">고양 덕양구·일산동구·일산서구 전지역 방문 출장마사지·홈타이 예약 안내 사이트입니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 경기도 고양시 전지역</span>
      </address>
      <div class="footer-cta">
        <a class="footer-cta-btn" href="{TELEGRAM_SITE}" target="_blank" rel="noopener nofollow">웹사이트 제작문의 <span aria-hidden="true">↗</span></a>
        <a class="footer-cta-btn" href="{TELEGRAM_BIZ}" target="_blank" rel="noopener nofollow">제휴문의 <span aria-hidden="true">↗</span></a>
      </div>
    </div>
    <nav class="footer-col" aria-label="지역 안내">
      <p class="footer-title">지역 안내</p>
      <ul>
        <li><a href="/gyeonggi/goyang/districts/">구별 안내</a></li>
        <li><a href="/gyeonggi/goyang/dong/">지역별 안내</a></li>
        <li><a href="/gyeonggi/goyang/station/">역세권 안내</a></li>
        <li><a href="/gyeonggi/goyang/area/">생활권 안내</a></li>
    ...
    <nav class="footer-col" aria-label="정책 및 기준">
      ...
      <ul>
        ...
        <li><a href="/guide/#safety">고객 안전 안내</a></li>
...
def build() -> None:
    ...
    for page in PAGES:
        path = page["path"]  # "" 또는 "gyeonggi/goyang/..." 형태
        ...
        if not noindex:
            ...
            rss_items.append((url, page["title"], page["desc"]))
    ...
    # sitemap.xml (lastmod 포함 — 색인 속도에 유리)
    urls = "\n".join(
    ...
    with open(os.path.join(ROOT, "rss.xml"), "w", encoding="utf-8") as f:
        f.write(
            ...
            "<channel>\n"
            f"  <title>{html.escape(BRAND)} — 고양 출장마사지·홈타이 안내</title>\n"
            f"  <link>{base}/</link>\n"
            f'  <atom:link href="{base}/rss.xml" rel="self" type="application/rss+xml"/>\n'
            "  <description>고양 덕양구·일산동구·일산서구 방문 출장마사지·홈타이 지역별 안내</description>\n"
